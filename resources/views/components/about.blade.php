        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-5 relative reveal-fade-left">
                <div class="parchment-scroll p-3 rounded-3xl antique-border shadow-xl aspect-[4/3] group overflow-hidden hover-lift">
                    <img src="{{ asset('images/mandir-aarti.jpg') }}" alt="Maha Aarti Ceremony" class="w-full h-full object-cover rounded-2xl transition-transform duration-1000 group-hover:scale-105">
                </div>
